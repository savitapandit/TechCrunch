...
<?php
////////// FONTS //////////
$tempera_googlefont = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_googlefont));
$tempera_googlefonttitle = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_googlefonttitle));
$tempera_googlefontside = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_googlefontside));
$tempera_headingsgooglefont = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_headingsgooglefont));
$tempera_sitetitlegooglefont = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_sitetitlegooglefont));
$tempera_menugooglefont = str_replace('+',' ',preg_replace('/:.*/i','',$tempera_menugooglefont));
?>
...
#header-full { background-color: <?php echo $tempera_backcolorheader; ?>; }
...
/* Main menu top level */
#access a { color: <?php echo $tempera_menucolortxtdefault; ?>; }
#access {background-color: <?php echo $tempera_menucolorbgdefault; ?>; }
#access > .menu > ul > li > a > span { border-right-color: <?php echo cryout_hexadder($tempera_menucolorbgdefault,'-30');?>; 
...
<?php if ($tempera_topbarwidth == 'Full width'){ ?> #topbar-inner {width:95%;} <?php } ?>
